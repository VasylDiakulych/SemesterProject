...
class MainWindow : Gtk.Window {
    ...
    public MainWindow(Opponent opponent = Opponent.HumanPlayer, Player player = Player.White, string startingPositionPath = "ChessLogic/Positions/standardPosition.txt") : base("Chess")
    {
